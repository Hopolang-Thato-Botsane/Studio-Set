...
export const howItWorksSteps: StepData[] = [
  {
    id: 1,
    iconSrc: "/assets/icons/strategy.svg", // Replace with your icon SVG path
  ...
  {
    id: 2,
    iconSrc: "/assets/icons/cube.svg", // Replace with your icon SVG path
  ...
  {
    id: 3,
    iconSrc: "/assets/icons/network.svg", // Replace with your icon SVG path
