...
const DEFAULT_ACCESSORY_SIZES = ["O/S"];
...
export const products: Product[] = [
  {
    ...
    image: "/assets/images/retail/quick-dry-slim-fit-weather-jacket.png",
    featured: true,
    inStock: true,
  ...
  },
  {
    ...
    image: "/assets/images/retail/warmth-retainer-winter-jacket.png",
    featured: true,
    inStock: true,
    sizes: ["S", "M", "L", "XL"],
    colors: [
  ...
  // {
  //   id: "prod_03",
  //   name: "Quick Clean Hard Shell - Boot",
  //   price: 1650,
  //   category: "footwear",
  //   gender: "unisex",
  ...
  // --- GENERAL APPAREL ---
  {
    ...
    image: "/assets/images/retail/heavy-duty-ipstop-crew-pant.png",
    inStock: true,
    sizes: ["30", "32", "34", "36"],
  ...
  },
  {
    ...
    image: "/assets/images/retail/reinforced-double-knee-utility-pant.png",
    inStock: true,
    sizes: ["28", "30", "32", "34"],
  ...
  },
  {
    ...
    image: "/assets/images/retail/thermal-fleece-midlayer-hood.png",
    inStock: true,
    sizes: DEFAULT_APPAREL_SIZES,
  ...
  {
    id: "prod_09",
    name: "Riggers Utility Jersey - Slick Black",
    price: 1100,
    ...
    image: "/assets/images/retail/riggers-utility-jersey-slick-black.png",
    inStock: true,
    sizes: ["S/M", "L/XL"],
  ...
  //   image: "/assets/images/retail/lightweight-breathable-crew-tee.png",
  //   inStock: true,
  //   sizes: DEFAULT_APPAREL_SIZES,
  //   colors: DEFAULT_COLORS
  // },
  ...
  //   image: "/assets/images/retail/steel-toe-boot-all-terrian-boot.png",
  //   inStock: true,
  //   sizes: DEFAULT_FOOTWEAR_SIZES,
  //   colors: [{ name: "Slick Black", hex: "#1A1A1A" }]
  // },
  {
    ...
    image: "/assets/images/retail/steel-toe-cap-all-terrain-boot.png",
    inStock: true,
  ...
  },
  {
    ...
    image: "/assets/images/retail/waterproof-mud-slogger-crew-boot.png",
    inStock: true,
    sizes: DEFAULT_FOOTWEAR_SIZES,
  ...
  },
  {
    ...
    image: "/assets/images/retail/lightweight-studio-slip-on-sneaker.png",
    inStock: true,
    sizes: DEFAULT_FOOTWEAR_SIZES,
  ...
  // --- ACCESSORIES & GEAR ---
  {
    ...
    image: "/assets/images/retail/touchscreen-ready-riggers-gloves.png",
    inStock: true,
    sizes: ["M", "L"],
    colors: [{ name: "Slick Black", hex: "#1A1A1A" }]
  },
  ...
  {
    id: "prod_17",
    name: "Blind Spot Flash - Operator Eyewear",
    price: 750,
    category: "accessories",
    gender: "unisex",
    ...
    image: "/assets/images/retail/blind-spot-flash-operator-eyewear.png",
    inStock: true,
    sizes: DEFAULT_ACCESSORY_SIZES,
    colors: [{ name: "Slick Black", hex: "#1A1A1A" }]
  },
  ...
  {
    id: "prod_19",
    name: "Fleece-Lined - Winter Beanie Cap",
    price: 280,
    category: "accessories",
    gender: "unisex",
    ...
    image: "/assets/images/retail/fleece-Lined-winter-beanie-cap.png",
    inStock: true,
    sizes: DEFAULT_ACCESSORY_SIZES,
    colors: DEFAULT_COLORS
  },
  {
    ...
    image: "/assets/images/retail/anti-dust-cotton-neck-gaiter.png",
    inStock: true,
    sizes: DEFAULT_ACCESSORY_SIZES,
    colors: DEFAULT_COLORS
  },
  ...
  // },
  {
    ...
    image: "/assets/images/retail/reinforced-rigging-pant-belt.png",
    inStock: true,
    sizes: DEFAULT_ACCESSORY_SIZES,
    colors: [{ name: "Slick Black", hex: "#1A1A1A" }]
  },
  ...
  // },
  {
    ...
    image: "/assets/images/retail/extreme-condition-hand-warmers-set.png",
    inStock: true,
    sizes: DEFAULT_ACCESSORY_SIZES,
    colors: [{ name: "Slick Black", hex: "#1A1A1A" }]
  }
